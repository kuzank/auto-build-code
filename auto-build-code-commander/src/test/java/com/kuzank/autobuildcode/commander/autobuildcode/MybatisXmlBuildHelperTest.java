...
import com.kuzank.autobuildcode.common.helper.MybatisXmlBuildHelper;
...
@SpringBootTest
public class MybatisXmlBuildHelperTest {
    ...
    public void buildTest() throws AutoBuildCodeException {
        ...
        AutoBuildCodeFile autoBuildCodeFile = new MybatisXmlBuildHelper(autoBuildCodeConfigBean).build(targetForm);
    ...
    public void getFileName() throws AutoBuildCodeException {
        ...
        System.out.println(new MybatisXmlBuildHelper(autoBuildCodeConfigBean).getFileName(targetForm, autoBuildCodeConfigBean));
    }
}
