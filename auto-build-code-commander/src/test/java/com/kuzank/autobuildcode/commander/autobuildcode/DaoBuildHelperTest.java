...
import com.kuzank.autobuildcode.common.helper.DaoBuildHelper;
...
@SpringBootTest
public class DaoBuildHelperTest {
    ...
    public void buildTest() throws AutoBuildCodeException {
        ...
        AutoBuildCodeFile autoBuildCodeFile = new DaoBuildHelper(autoBuildCodeConfigBean).build(targetForm);
    ...
    public void getFileName() throws AutoBuildCodeException {
        ...
        System.out.println(new DaoBuildHelper(autoBuildCodeConfigBean).getFileName(targetForm, autoBuildCodeConfigBean));
    }
