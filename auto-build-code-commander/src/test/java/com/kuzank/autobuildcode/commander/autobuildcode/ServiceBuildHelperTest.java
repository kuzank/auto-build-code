...
import com.kuzank.autobuildcode.common.helper.ServiceBuildHelper;
...
@SpringBootTest
public class ServiceBuildHelperTest {
    @Autowired
    ...
    public void buildTest() throws AutoBuildCodeException {
        ...
        AutoBuildCodeFile autoBuildCodeFile = new ServiceBuildHelper(autoBuildCodeConfigBean).build(targetForm);
    ...
    public void getFileName() throws AutoBuildCodeException {
        ...
        System.out.println(new ServiceBuildHelper(autoBuildCodeConfigBean).getFileName(targetForm, autoBuildCodeConfigBean));
    }
}
